...
public final class EventCall__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x181cb8f23d5e4aa9L, 0xb8cd2e496087f7c8L, 0x58d666a512946884L, "BSML.structure.EventCall");
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getActuals_id6WGVxckB05Y, getActualsLink_id2$xXL4HCFy0, getFormals_id6WGVxckB065, getReturnType_id7$$5Stoo8Y$, getFunction_id74lwjTQiYY5, simpleOneLiner_id1z9MsBsVy8o);

  private static void ___init___(@NotNull SNode __thisNode__) {
  }

  /*package*/ static List<SNode> getActuals_id6WGVxckB05Y(@NotNull SNode __thisNode__) {
    return SLinkOperations.getChildren(__thisNode__, MetaAdapterFactory.getContainmentLink(0x181cb8f23d5e4aa9L, 0xb8cd2e496087f7c8L, 0x58d666a512946884L, 0x58d666a512969021L, "actuals"));
  }
  /*package*/ static SNode getActualsLink_id2$xXL4HCFy0(@NotNull SAbstractConcept __thisConcept__) {
    return SLinkOperations.findLinkDeclaration(MetaAdapterFactory.getContainmentLink(0x181cb8f23d5e4aa9L, 0xb8cd2e496087f7c8L, 0x58d666a512946884L, 0x58d666a512969021L, "actuals"));
  }
  /*package*/ static List<SNode> getFormals_id6WGVxckB065(@NotNull SNode __thisNode__) {
    return ListSequence.fromList((new ArrayList<SNode>())).addSequence(Sequence.fromIterable(IEvent__BehaviorDescriptor.args_id5zmpEki_82Q.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getReferenceLink(0x181cb8f23d5e4aa9L, 0xb8cd2e496087f7c8L, 0x58d666a512946884L, 0x58d666a512969023L, "event_ref")))));
  }
